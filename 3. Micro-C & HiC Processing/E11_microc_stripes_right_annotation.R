...
##### stripes right - gate by end anchor
#####
loop_common <- readRDS("stripes_right_merged")
...
saveRDS(loop_common, "stripes_right_merged_hictable")
...
saveRDS(loop_common, "stripes_right_merged_hictable_ann")
...
saveRDS(loop_common, "stripes_right_merged_hictable_ann_chip")
